...
system_prompt = (
    ...
    "2. If the query is about recommendations (INCLUDE entry price, timings, and open days when applicable):\n"
    "   {{ \"type\": \"places\", \"location\": \"X\", \"category\": \"Y\", \"places\":[ {{\"name\":\"A\",\"speciality\":\"B\",\"address\":\"C\",\"entry_price\":\"Free/₹500/etc\",\"timings\":\"9 AM - 6 PM\",\"open_days\":\"Mon-Sun/Closed on Mondays/etc\"}} ] }}\n"
    "   Note: Include entry_price (or \"Free\" if no charge), timings (opening-closing hours), and open_days (weekdays open). Use \"N/A\" if not applicable.\n\n"
...
async def generate_response(
    prompt: str = Query(..., min_length=1, description="Your travel/food/places/lifestyle question"),
