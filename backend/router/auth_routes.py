...
from auth import hash_password, verify_password, create_access_token,generate_otp, save_otp, send_otp_email, check_otp
...
async def signup(user: UserCreate):
    ...
    # Create and return access token for auto-login
